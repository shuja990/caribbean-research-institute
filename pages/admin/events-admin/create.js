  ...
  return (
    <>
      <div className="login-container">
        <Head>
          <title>Create Event - Caribbean Research Institute</title>
          <meta
            property="og:title"
            content="Create Event - Caribbean Research Institute"
          />
        </Head>
        ...
        <div className="vh-50 d-flex justify-content-center align-items-center login-container">
          <div className="col-md-5 p-5 shadow-sm bg-white">
            <h2 className="text-center mb-4 text-primary">Add Event</h2>
